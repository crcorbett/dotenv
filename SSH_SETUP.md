...
# 256 SHA256:YgTCV5... development-vm-cooper_key (ED25519)
...
The dotfiles provide a basic SSH config that works on both platforms:

```ssh-config
# From: home/dotfiles/ssh_config

# Development VMs (Tailscale)
Host dev-vm development-vm-cooper
    HostName 100.126.134.39
    User cooper

Host dev-vm-uk development-vm-cooper-uk
    HostName 100.105.217.122
    User cooper
...
Example bookmarks for our dev VMs:

| SSH Key Item | Bookmark URLs |
|--------------|---------------|
| `development-vm-cooper_key` | `ssh://cooper@development-vm-cooper`<br>`ssh://cooper@100.126.134.39` |
| `Azure Dev VM SSH Key` | `ssh://cooper@development-vm-cooper-uk`<br>`ssh://cooper@100.105.217.122` |
...
# 1Password Item: development-vm-cooper_key
Match Host development-vm-cooper User cooper
  IdentitiesOnly yes
  IdentityFile ~/.ssh/1Password/SHA256_YgTCV5lJfj5Mwrf4yc4HQFnw2D5djQLGIg_U6HCbMsg.pub

# 1Password Item: Azure Dev VM SSH Key
Match Host development-vm-cooper-uk User cooper
  IdentitiesOnly yes
  IdentityFile ~/.ssh/1Password/SHA256_ZGbqlgErYVQrHKDnXilLAP89l7GmPUst+J15n9dmnWU.pub
